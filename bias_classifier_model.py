"""
Bias Classifier Model using Machine Learning
Classifies resumes into High/Medium/Low bias categories
"""
...
class BiasClassifier:
    """
    Machine Learning model to classify bias level as High/Medium/Low
    Uses Gradient Boosting with feature engineering
    """
    ...
    def predict(self, data):
        """Predict bias labels for new data"""
        if not self.trained:
